window.onload = function () {
    ...
    axios.get('http://127.0.0.1:8000/bebidas')
...
function guardarCambios() {
    ...
    axios.put(`http://127.0.0.1:8000/bebidas/${id}`, {
        nombre: nombre,
...
function agregarProducto() {
    ...
    // Llamada al backend para actualizar
    axios.post('http://127.0.0.1:8000/bebidas', {
        nombre: nombre,
        descripcion: descripcion,
        precio: precio,
        cantidad: cantidad
...
try {
    if (id) {
        ...
        const response = await axios.put(`http://127.0.0.1:8000/bebidas/${id}`, productoData);
        ...
        const response = await axios.post('http://127.0.0.1:8000/bebidas', productoData);
...
axios.delete(`http://127.0.0.1:8000/bebidas/${id}`)
    .then(() => {
